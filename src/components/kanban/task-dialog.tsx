      ...
      >
        ...
        <div className="px-5 py-4 space-y-4 overflow-y-auto flex-1">
          ...
          <div className="space-y-1.5">
            <label className="block text-xs font-medium text-gray-700">
              Source URLs
              <span className="ml-1 text-xs font-normal text-gray-500">(for deep content scraping with Bright Data)</span>
            </label>
            <Textarea
              value={sourceUrls}
              ...
              rows={3}
              className="text-sm resize-none bg-white border-gray-300 text-gray-900 placeholder:text-gray-400 font-mono"
              style={{
                padding: '8px',
                borderRadius: '6px',
                border: '1px solid #ccc',
            ...
            />
            <p className="text-xs text-gray-500">
              Add specific URLs to scrape for exact CTAs, offers, and T&Cs. One URL per line.
            </p>
          </div>
